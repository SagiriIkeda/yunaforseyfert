//@ts-expect-error i dont want to spend time on this :)
import didyoumean from "didyoumean2";

import { Client, type Command, type SubCommand, type UsingClient } from "seyfert";
import { HandleCommand } from "seyfert/lib/commands/handle";
import { describe, expect, test } from "vitest";
import AccountCommand from "../bot/commands/account/account";
import CreateCommand from "../bot/commands/account/create";
import OtherCommand from "../bot/commands/account/other";
import EvalCommand from "../bot/commands/eval";
...
import { prepareCommands, type YunaGroup } from "../src/utils/commandsResolver/prepare";
