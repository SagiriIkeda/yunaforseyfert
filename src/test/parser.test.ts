...
describe("words", () => {
    ...
    test("one words", () =>
        testParser("penguin world", { first: "penguin", second: "world" })
    )
...
describe("long text tags", () => {
    ...
    test("disableLongTextTagsInLastOption", () =>
        testParser("penguin 'beautiful sentence'", { first: "penguin", second: "'beautiful sentence'" }, { disableLongTextTagsInLastOption: true })
    )
...
describe("named options", () => {
    ...
    test("configured", () =>
        testParser("-first test --second take this", { first: "test -", second: "take this" }, {
            enabled: {
                namedOptions: ["-"]
            }
        })
    ...
    test("configured, ignoring :", () =>
        testParser("--first penguin life second: test --second take this", { first: "penguin life second: test", second: "take this" }, {
            enabled: {
                namedOptions: ["-", "--"]
            }
        })
    ...
    test("useUniqueNamedSyntaxAtSameTime", () =>
        testParser("--first penguin life -second test first: take this", { first: "penguin life", second: "test first: take this" }, {
